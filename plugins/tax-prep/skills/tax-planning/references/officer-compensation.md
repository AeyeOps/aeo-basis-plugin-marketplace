...
S-corps have the opposite incentive: lower compensation = lower payroll tax. The IRS scrutinizes S-corp officer pay to ensure it is not unreasonably low. This comes up in cross-entity advisory work when evaluating S-corp clients or entity selection.
...
This test is particularly relevant for closely-held C-corps where the officer-shareholder controls both sides of the transaction.
...
For years where the corporation had no payroll but the officer was active:
