...
For platform-specific report pulls and journal entry posting, invoke `qbo-integration:qbo-reporting` and `qbo-integration:qbo-bookkeeping`.
...
- **E&P vs. book retained earnings**: The accounting system tracks book retained earnings; E&P requires tax adjustments (depreciation differences, tax-exempt income, nondeductible expenses). Maintain a separate E&P schedule outside the GL
