...
For platform-specific journal entry posting, invoke `qbo-integration:qbo-bookkeeping`.
...
- **Valuation allowance**: Record as a contra-asset to the DTA (credit Valuation Allowance, debit Income Tax Expense)
...
- **Reconciliation**: The income tax expense per the income statement should tie to the provision workpaper. Any difference indicates a posting error
